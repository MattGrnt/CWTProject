...
```{r 62.Day.cleaning}
#| code-summary: Cleaning data for 62 day wait
...
#| code-summary: 62 day target predictions
#| column: page-inset-right
...
Try the simple model first and decide if it is good enough. 
